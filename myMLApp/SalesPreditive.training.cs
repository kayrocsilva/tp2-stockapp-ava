...
namespace MyMLApp
{
    public partial class SalesPreditive
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"Month", @"Month")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=8,FeatureFraction=0.9551058F,LabelColumnName=@"Sales",FeatureColumnName=@"Features"}));
